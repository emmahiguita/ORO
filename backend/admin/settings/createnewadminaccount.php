...
$stmt->execute([$id,$username,$email,$phone,password_hash($password,PASSWORD_DEFAULT),random_int(100000,999999),1,2,'default.png','default.png']);
jsonResponse(['status'=>'success','data'=>['user_id'=>$id,'user_name'=>$username,'user_email'=>$email,'user_phone'=>$phone,'user_approve'=>1,'user_keyaccess'=>2]],201);
