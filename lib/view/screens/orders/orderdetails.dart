      ...
      body: GetBuilder<OrderDetailsControllerImp>(
          ...
          builder: (controller) {
            ...
            final List<Map<String, dynamic>> steps =
                controller.getSteps(orderType);
            final int currentStatus =
                controller.orderDetails[0].orderStatus ?? 0;
            ...
            if (orderDateStr.isNotEmpty) {
              try {
                formattedDate = Jiffy.parse(orderDateStr)
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: controller
                                      .getStatusColor(currentStatus, orderType)
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  DetailRow(
                                    label: "Building",
                                    value: controller
                                        .orderDetails[0].addressBuilding!,
                                  ),
                                  DetailRow(
                                    label: "Street",
                                    value: controller
                                        .orderDetails[0].addressStreet!,
                                  ),
                                  DetailRow(
                                    label: "Block",
                                    value: controller
                                        .orderDetails[0].addressBlock!,
                                  ),
                                  DetailRow(
                                    label: "Floor",
                                    value: controller
                                        .orderDetails[0].addressFloor!,
                                  ),
                                ],
                              ),
                            ),
